...
<div class="form-group {{ $errors->has('dislike') ? 'has-error' : ''}}">
    {!! Form::label('dislike', 'Dislike', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('dislike', null, ['class' => 'form-control']) !!}
        {!! $errors->first('dislike', '<p class="help-block">:message</p>') !!}
    </div>
</div>
