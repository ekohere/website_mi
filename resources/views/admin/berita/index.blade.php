        ...
        <div class="row">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/berita/create') }}" class="mb-xs mt-xs mr-xs btn btn-success" title="Add New beritum"><i class="fa fa-plus"></i> Tambah</a>
                            ...
                            <table class="table table-no-more table-bordered table-striped mb-none">
                                ...
                                @foreach($berita as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/berita/' . $item->id) }}" class="btn btn-success btn-xs" title="View beritum"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a>
                                            <a href="{{ url('/admin/berita/' . $item->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit beritum"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
