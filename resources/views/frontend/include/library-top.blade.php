...
<title>Home Program Studi Manajemen Informatika</title>
...
<!-- Theme CSS -->
<link rel="stylesheet" href="{{asset('assets/frontend/css/theme.min.css')}}">
<link rel="stylesheet" href="{{asset('assets/frontend/css/theme-elements.min.css')}}">
